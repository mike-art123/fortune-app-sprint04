...
const VOICE = [
  ...
  '',
  'قواعد قطعی:',
  '۱. نشانه را قاطع بخوان، ولی آینده را قطعی نکن. نشانه می‌گوید «این‌چنین است»،',
  'نه «این‌چنین خواهد شد». وعده و تضمین نده.',
  '۲. هرگز دربارهٔ بیماری، مرگ، بارداری، طلاق یا مسائل مالی مشخص چیزی نگو.',
