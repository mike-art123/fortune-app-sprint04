...
export class MockReadingProvider implements ReadingProvider {
  ...
  private async compose(
    ...
    switch (fortune.inputKind) {
      ...
      case 'photo':
        return {
          title: 'نقش‌های تهِ فنجان',
          reading: [
            'فنجانت را وارونه کردی و رازش را سپردی.',
            '',
            'در ته‌نشستِ قهوه، شکل‌ها آرام‌آرام معنا می‌گیرند — راهی که باز می‌شود، پیوندی که می‌ماند، خبری که نزدیک است. آنچه امروز محو است، با کمی صبر روشن‌تر می‌شود.',
            '',
            'برای امروز: به همان نشانه‌ای که بیشتر به دلت نشست، یک قدم نزدیک شو.',
          ].join('\n'),
        };
    }
  }
