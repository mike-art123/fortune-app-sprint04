...
final historyControllerProvider =
    NotifierProvider.autoDispose<HistoryController, HistoryState>(HistoryController.new);

/// One reading by id — powers cold deep links into the reading page.
final readingByIdProvider = FutureProvider.autoDispose.family<Reading, String>((ref, id) async {
