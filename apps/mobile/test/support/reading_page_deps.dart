...
/// What the reading screen now depends on beyond the reading itself: it may
/// end with «بعد از این», which reads the profile and the history. Any test
/// that lands on that screen declares these instead of letting the real
/// startup, auth and network run inside a widget test.
List<Override> readingScreenDeps() => [
      profileControllerProvider.overrideWith(InertProfile.new),
