...
void main() {
  test('stored preference wins', () {
    expect(SupportedLocales.resolve('en', const Locale('fa')), SupportedLocales.en);
  });

  test('system locale is used when nothing is stored', () {
    expect(SupportedLocales.resolve(null, const Locale('en')), SupportedLocales.en);
  });

  test('unsupported system locale falls back to Persian', () {
    expect(SupportedLocales.resolve(null, const Locale('de')), SupportedLocales.fa);
  });
